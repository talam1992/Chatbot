...
def min_salary(job, place):
    ...
    if len (min_) > 0:
        ...
        h = '\n'
        reply = {
            'display': f'The Minimum Salary for {job} in {place} from indeed website is £{add_format (min_[min_job])} Annually. '
...
def max_salary(job, place):
    ...
    if len (max_) > 0:
        ...
        h = '\n'
        reply = {
            'display': f'The Maximum Salary for {job} in {place} from indeed website is £{add_format (max_[min_job])} Annually. '
