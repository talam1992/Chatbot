    ...
    try:
        if line.strip ()[-1].isnumeric ():
            ...
            for nap_id in station_ids:
                ...
                dict_time = {}
                for i in json_data:
                    dict_time[json_data.index (i)] = format(i["expectedArrival"].split ('T'))
